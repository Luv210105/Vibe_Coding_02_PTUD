...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 text-slate-900 dark:text-white">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-2xl dark:bg-slate-950 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="bg-black p-10 text-white">
          <p className="text-sm uppercase tracking-[0.24em] text-slate-300">Library MVP</p>
        ...
        <div className="p-8 md:p-10">
          <div>
            <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Đăng nhập hệ thống</h2>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Sử dụng tài khoản mặc định để kiểm thử nhanh.</p>
          </div>
          ...
          <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600 dark:bg-slate-900 dark:text-slate-300">
            <p className="font-semibold text-slate-800 dark:text-white">Tài khoản gợi ý</p>
            <p>`admin` / `Admin@123`</p>
